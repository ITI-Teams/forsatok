        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow-lg border-0 rounded-4 mb-4 w-100 bg-body text-body">
                <div class="card-body p-4">
                    <form wire:submit.prevent="updateProfile" novalidate enctype="multipart/form-data">
                        <div class="row g-3">

                            {{-- Avatar Upload --}}
                            <div class="col-12">
                                <label class="form-label fw-semibold">
                                    <i class="fa-solid fa-image text-primary me-2"></i>Company Logo / Avatar
                                </label>
                                <div class="d-flex align-items-center gap-4">
                                    {{-- Current Avatar Preview --}}
                                    @if($current_avatar)
                                        <div class="avatar-preview me-3">
                                            <img src="{{ Storage::disk('public')->url($current_avatar) }}"
                                                 alt="Current Avatar"
                                    ...
                                    @else
                                        <div class="avatar-placeholder me-3">
                                            <div class="rounded-circle bg-light d-flex align-items-center justify-content-center border"
                                                ...
                                                <i class="fa-solid fa-building text-muted" style="font-size: 2rem;"></i>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        @enderror
                                        <div class="form-text">
                                            Upload a company logo or avatar. Max: 2MB (JPEG, PNG, JPG, GIF)
                                        </div>
                                        ...
                                        @if($avatar)
                                            <div class="mt-2">
                                                    <span class="text-success">
                                                        ...
                                                        New image selected: {{ $avatar->getClientOriginalName() }}
                                                    </span>
                                            </div>
                                        @endif
                                    </div>
