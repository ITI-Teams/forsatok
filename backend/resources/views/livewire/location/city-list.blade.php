<div class="container" data-bs-theme="auto">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 fw-bold text-body">Cities</h1>
        <a href="{{ route('cities.trash') }}" wire:navigate
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('cities.create') }}" 
           class="btn btn-primary d-flex align-items-center gap-2">
            <i class="fa-solid fa-plus"></i> Create New City
        </a>
    </div>
    ...
    <div class="card shadow-sm border-0 rounded-4 overflow-hidden">
        ...
        <div class="card-header bg-body-tertiary py-3">
            <h6 class="mb-0 text-secondary fw-semibold">All Cities</h6>
        </div>
