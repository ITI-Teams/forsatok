<div class="container-fluid px-3 px-md-4 py-3 bg-body text-body">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        <h4 class="fw-semibold mb-0">
            <i class="fa-solid fa-trash-can me-2 text-danger"></i> Deleted Countries
        </h4>
        <a wire:navigate href="{{ route('countries.index') }}" class="btn btn-outline-secondary">
            <i class="fa-solid fa-arrow-left me-2"></i> Back to Countries
        </a>
    </div>
        ...
        <div class="card-body p-0">
            @if($trashedCountries->isEmpty())
                <div class="text-center py-5">
                    ...
                    <p class="text-secondary mb-0">No deleted countries found</p>
                </div>
            @else
                        ...
                        <tbody>
                            @foreach($trashedCountries as $country)
                                <tr>
                                    ...
                                    <td class="text-nowrap">{{ $country->deleted_at->diffForHumans() }}</td>
                                    <td class="text-nowrap text-end">
                                        <div class="d-flex flex-wrap justify-content-end gap-2">
                                            <button type="button"
                                                    onclick="confirmRestore({{ $country->id }})"
                                            ...
                                            <button type="button"
                                                    onclick="confirmForceDelete({{ $country->id }})"
