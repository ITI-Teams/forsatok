<div class="container-fluid py-2">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        <h4 class="fw-semibold mb-0">
            ...
            @if ($countryId) Edit Country @else Create Country @endif
        </h4>
        <a wire:navigate href="{{ route('countries.index') }}" class="btn btn-outline-secondary d-flex align-items-center">
            ...
            <form wire:submit.prevent="save">
                <div class="row g-4">
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">
                            <i class="fa-solid fa-flag me-2 text-primary"></i>Name
                        </label>
                    ...
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">
                            <i class="fa-solid fa-hashtag me-2 text-primary"></i>Code
                        </label>
                ...
                <div class="mt-4 d-flex flex-wrap justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary px-4">
                        ...
                        @if ($countryId) Update @else Create @endif
                    </button>
                </div>
            </form>
        </div>
