<div class="container-fluid px-3 px-md-4 py-3 bg-body text-body">
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
        <h4 class="fw-semibold mb-0">
            <i class="fa-solid fa-trash-can me-2 text-danger"></i> Deleted Categories
        </h4>
        <a wire:navigate href="{{ route('categories.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="card-body p-0">
            @if($trashedCategories->isEmpty())
                <div class="text-center py-5">
                    ...
                    <p class="text-secondary mb-0">No deleted categories found</p>
                </div>
            @else
                        ...
                        <tbody>
                            @foreach($trashedCategories as $category)
                                <tr>
                                    ...
                                    <td class="text-nowrap">{{ $category->deleted_at->diffForHumans() }}</td>
